...
create() {
	...
	case $install_type in
      ...
      echo "$mariadb_url $mariadb_user $mariadb_password $mariadb_port $mariadb_database $redis_url $redis_password $redis_port $middleware_ip  $jvm_mem $es_port $es_password $es_url"

			export_env $mariadb_url $mariadb_user $mariadb_password $mariadb_port $mariadb_database $redis_url $redis_password $redis_port $middleware_ip  $jvm_mem $es_port $es_password $es_url
			export_redis_conf $redis_password
			export_nginx_conf
